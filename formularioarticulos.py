...
ventana1=tk.Tk()
ventana1.title("Administrar ")
cuaderno1 = ttk.Notebook(ventana1)        listado_completo()
    ...
    def listado_completo(self):
        ...
        self.cuaderno1.add(self.pagina3, text="Personas Registradas")
        self.labelframe3=ttk.LabelFrame(self.pagina3, text="Finca San José")
    ...
    def listar(self):
        ...
        for fila in respuesta:
            self.scrolledtext1.insert(tk.END, "cedula:"+str(fila[0])+"\nNombre:"+fila[1]+"\nApellido"+str(fila[2])+"\n\n")
